...
2.
- To run ETL pipeline that cleans data and stores in database `python3 data_preparations/process_data.py data_preparations/messages.csv data_preparations/categories.csv data_preparations/DisasterResponse.db`
- To run ML pipeline that trains classifier and saves `python3 models/train_classifier.py data_preparations/DisasterResponse.db models/classifier.pkl`
